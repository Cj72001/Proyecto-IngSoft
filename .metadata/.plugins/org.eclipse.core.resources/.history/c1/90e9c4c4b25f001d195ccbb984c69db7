...
<body>
    <div class="main">
        ...
        <img src="<c:url value='/resources/img/schedule.jpg'/>" width="200px"/>
            <div class="box">
                ...
                <br> <input class="box1"type="submit" value="ACTUALIZAR HORAS INTERNAS">
                ...
                <br> <input class="box1"type="submit" value="ACTUALIZAR HORAS EXTERNAS">
                <h3>${errorSoU2}</h3>
            </div> <!-- End Box -->
        </form>
        ...
        <div>
            <div>
                <a href="mainPage.html">Regresar al Inicio</a>
            </div>
        </div>
